<?php
   ...
   // Verifica si la sesión está iniciada
    ...
    $resultado = $mysqli -> query("SELECT nombre_producto, precio FROM productos ORDER BY nombre_producto;
                                ");
...
<?php
    ...
    <table id="tablaProductos" class="table table-striped table-bordered border-secondary">
  <thead>
    <tr>
      <th scope="col">#</th>  
  ...
  <?php
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><i class="fa-solid fa-dollar-sign"></i> <?php echo $registro['precio']; ?></td>
                    </tr>
                <?php
