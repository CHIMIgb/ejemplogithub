...
<body>
    ...
    <form action="alta_usuarios.php" method="POST">
        ...
        <div class="container" style="width: 65%; border: 1px solid black; padding: 1rem; border-radius: 10px; margin: 1rem auto;">
            ...
            <div class="row">
                <div class="col">
                    <h1 align="center">Alta usuarios</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <select class="form-control <?php echo isset($_POST['tipo']) && empty($_POST['tipo']) ? 'is-invalid' : 'is-valid'; ?>" name="sexo" id="sexo" required>
                        <option value="">Elija su sexo..</option>
                        <option value="1" <?php echo ($usuarioActual['sexo'] == 1) ? 'selected' : ''; ?>>Hombre</option>
                        <option value="2" <?php echo ($usuarioActual['sexo'] == 2) ? 'selected' : ''; ?>>Mujer</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <label for="" class="form-label"><i class="fa-solid fa-user-tie"></i> Tipo</label>
                    <select class="form-control <?php echo isset($_POST['tipo']) && empty($_POST['tipo']) ? 'is-invalid' : 'is-valid'; ?>" name="tipo" id="tipo" required>
                        <option value="">Elija un tipo...</option>
                        <?php
                        $resultado = $mysqli->query("SELECT pk_tipo, tipo FROM tipo ORDER BY tipo");
...
if (isset($_POST['nombre']) && isset($_POST['apellido1']) && isset($_POST['apellido2']) && isset($_POST['edad']) && isset($_POST['sexo']) && isset($_POST['usuario']) && isset($_POST['clave']) && isset($_POST['tipo'])) {
    ...
    if ($countUser > 0) {
        ...
        mysqli_stmt_bind_param($stmtInsertUsuario, "sssiisss", $_POST['nombre'], $_POST['apellido1'], $_POST['apellido2'], $_POST['edad'], $_POST['sexo'], $_POST['tipo'], $fecha, $hora);
